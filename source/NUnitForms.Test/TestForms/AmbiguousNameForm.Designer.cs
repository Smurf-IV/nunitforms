...
{
    private TestForms.ButtonControl myControl1;

    private TestForms.ButtonControl myControl2;
    ...
    {
        this.myControl2 = new TestForms.ButtonControl();
        this.myControl1 = new TestForms.ButtonControl();
