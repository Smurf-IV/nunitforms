...
partial class MainForm
{
    ...
    private Button buttonPrimaryScreen;
    private GroupBox groupBox;
    private Button buttonWorkingArea;
    private Button buttonVirtualScreen;
    private Button buttonAllScreens;
    private Button buttonAllFormats;
    private Button buttonPrintScreen;
